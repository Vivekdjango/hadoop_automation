...
stdin, stdout, stderr = ssh.exec_command('/opt/gridscripts/gridopstools/bin/lda-monitor.sh -p cbp -jrcconversion -b 12 -t15 -s KILLED,FAILED,TIMEDOUT -d -cgold;/opt/gridscripts/gridopstools/bin/lda-monitor.sh -p cbp -jrcconversion -b 12 -t15 -s KILLED,FAILED,TIMEDOUT -c gold -r')
