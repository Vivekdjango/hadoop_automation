...
stdin, stdout, stderr = ssh.exec_command('/opt/gridscripts/gridopstools/bin/lda-monitor.sh -f /opt/gridscripts/ivory/pipeline-properties/rtbi.properties -p rtbi -b 6 -t40 -s KILLED,FAILED,TIMEDOUT -c gold -d;/opt/gridscripts/gridopstools/bin/lda-monitor.sh -f /opt/gridscripts/ivory/pipeline-properties/rtbi.properties -p rtbi -b 6 -t40 -s KILLED,FAILED,TIMEDOUT -c gold -r')
...
stdin, stdout, stderr = ssh.exec_command('/opt/gridscripts/gridopstools/bin/lda-monitor.sh -f /opt/gridscripts/ivory/pipeline-properties/rtbi.properties -p rtbi -b 6 -t40 -s KILLED,FAILED,TIMEDOUT -c hkg1 -d;/opt/gridscripts/gridopstools/bin/lda-monitor.sh -f /opt/gridscripts/ivory/pipeline-properties/rtbi.properties -p rtbi -b 6 -t40 -s KILLED,FAILED,TIMEDOUT -c hkg1 -r')
